...
export default function PublicEmpty({}: Props) {
  return (
    <div className="flex items-center mt-6 text-center border rounded-lg h-96 dark:border-gray-700">
        <div className="flex flex-col w-full max-w-sm px-4 mx-auto">
            ...
            <h1 className="mt-3 text-lg text-gray-800 dark:text-white">Oops! We don't have any journals published</h1>
            <p className="mt-2 text-gray-500 dark:text-gray-400">But you could change that by being the first to create one by signing up below </p>
            <div className="flex items-center mt-4 sm:mx-auto gap-x-3">
                ...
                <Button className="flex items-center justify-center w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 rounded-lg shrink-0 sm:w-auto  ">
                    <Link className='flex gap-x-2' href="/login">
