...
export default function JournalLoading({}: Props) {
  return (
    <div role="status" className="mx-auto hidden w-full flex-col items-center justify-center space-y-8 md:flex" >
        <div className="mx-auto flex w-full animate-pulse flex-row space-x-6 space-y-3 rounded-md border border-gray-200 p-4 shadow dark:border-gray-700 md:p-6">
            <div className="flex flex-col  md:w-6/12 w-full ">
                ...
                <div className="mt-4 flex flex-col h-80 w-full items-center justify-center rounded bg-gray-300 dark:bg-gray-700">
                    <svg
            ...
            <div className="mt-4 flex-col md:w-6/12 w-full border-2 border-red-600">
                <div className="mb-4 h-8 w-10/12 mx-auto my-2 rounded-full bg-gray-200 dark:bg-gray-700"></div>
