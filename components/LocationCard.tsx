...
export default function LocationCard({}: Props) {
  return (
    ...
    <div className="flex md:flex-row flex-col my-5">
        ...
        <div className="md:w-6/12 w-full rounded-lg lg:px-8 md:px-4 px-4 md:ml-3 ">
            ...
            <Link href="/home" className="w-1/2 flex items-center underline text-[#f25f14] text-xs">View on Google Maps</Link>
            </div>
            ...
            <Link href="/home" className='flex mr-3 justify-end text-xs md:text-sm my-5 opacity-70 border-2 ' >2 comments</Link>
            <div className="flex w-full items-center my-2 justify-between">
                <span className="flex items-center flex-col hover:border rounded-lg p-3 cursor-pointer hover:opacity-60 ">
                    <FiThumbsUp />
